    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('twitter_profile_link', models.URLField(blank=True, verbose_name='Twitter Profile Link')),
                ('linkedin_profile_link', models.URLField(blank=True, verbose_name='LinkedIn Profile Link')),
                ('resume_link', models.URLField(blank=True, verbose_name='Link to your resume')),
